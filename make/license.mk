...
go-licenses: $(BIN_DIR)
	@if [ ! -f "$(GO_LICENSES)" ]; then \
		...
		GOBIN=$(abspath $(BIN_DIR)) go install github.com/google/go-licenses/v2@$(GO_LICENSES_VERSION); \
	else \
...
third-party-licenses: go-licenses
	...
	@$(GO_LICENSES) save ./... --save_path=third_party_licenses --ignore=github.com/modern-go/reflect2 --ignore=sigs.k8s.io/node-feature-discovery/api/nfd/v1alpha1
